...
public class GeometriesTests {
    ...
    void findIntersections1() {
        ...
        assertNull(g.findIntersections(ray), "Failed to find Intersections when there are no shapes");
    }
    ...
    void findIntersections2() {
        ...
        Ray ray = new Ray(new Point(-4,0.5,1), new Vector(-5,0,1));
        assertNull(gmo.findIntersections(ray), "Failed to find Intersections when ray doesn't intersect any geometries");
    }
    ...
    void findIntersections3() {
        ...
        assertEquals(1, gmo.findIntersections(ray).size(), "Failed to find Intersections when ray intersects only one of the geometries");
    }
    ...
    void findIntersections4() {
        ...
        assertEquals(2, gmo.findIntersections(ray).size(), "Failed to find Intersections when ray intersects some geometries but not all");
    }
    ...
    void findIntersections5() {
        ...
        assertEquals(3, gmo.findIntersections(ray).size(), "Failed to find Intersections when ray intersects all the geometries");
    }
}
